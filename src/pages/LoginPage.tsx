      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          <div className="flex gap-3 mb-8">
            <button className="flex-1 h-12 rounded-xl bg-card border border-border font-semibold text-sm text-foreground hover:bg-muted transition-colors flex items-center justify-center gap-2 shadow-card">
            ...
            <button className="flex-1 h-12 rounded-xl bg-card border border-border font-semibold text-sm text-foreground hover:bg-muted transition-colors flex items-center justify-center gap-2 shadow-card">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.365 1.43c0 1.14-.493 2.27-1.177 3.08-.744.9-1.99 1.57-2.987 1.57-.18 0-.36-.02-.53-.06-.17-.04-.28-.06-.33-.06 0-.18.06-.42.17-.7.5-1.17 1.73-2.43 2.86-2.93.58-.26 1.33-.5 2-.5h.01zm4.565 17.01c-.06.18-.12.33-.18.48a11.5 11.5 0 01-1.17 2.15c-.51.72-1.05 1.45-1.89 1.45-.71 0-1.19-.46-1.89-.47-.74-.01-1.2.41-1.89.48h-.23c-.56 0-1.08-.56-1.69-1.25a14.4 14.4 0 01-2.68-5.17c-.04-.14-.07-.28-.1-.42a7.3 7.3 0 01-.3-2.08c0-2.15 1.07-3.6 2.47-3.6.7 0 1.28.46 1.74.46.42 0 1.08-.48 1.92-.48.67 0 2.04.34 2.72 1.67-.07.04-1.63.95-1.61 2.83.02 2.25 1.97 3 2 3.01z"/></svg>
              Apple
            </button>
          </div>
